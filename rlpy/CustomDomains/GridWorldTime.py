...
class GridWorldTime(Domain):

    """
    The GridWorldTime domain simulates a path-planning problem for a mobile robot
    in an environment with obstacles - modified with intermediate rewards, classified as DOOR position. 
    ...
    **REWARD:**
    ...
    def expectedStep(self, s, a): #TODO - NOT UPDATED CORRECTLY; May mess with calculating the representation; only for MDP solvers
